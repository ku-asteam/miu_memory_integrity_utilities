...
/// Initialize Framer pass
void initializeFramerPass(PassRegistry &);
void initializeFramerLoopOptPass(PassRegistry &);
void initializeFramerDelSafeAccessPass(PassRegistry &);
