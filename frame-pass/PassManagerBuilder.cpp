...
// inserted loop simplify pass. Is this correct?
//  PM.add(createLoopDeletionPass()); //test4s 
  
  if (EnableLoopInterchange)       // test123s 
  ...
  if (!DisableUnrollLoops)
    PM.add(createLoopUnrollPass());  //test1e
//upto here  
// reference: https://groups.google.com/forum/#!topic/llvm-dev/bsvL5JsH3W0
  PM.add(createSimpleLoopUnrollPass());    // Unroll small loops //test2e
...
///FRAMER: ADD following line, not RunInliner below??
